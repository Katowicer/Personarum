...
/**
 * Trasferisce i dati dell’operazione UpdateProfileDocumentRequest tra API REST e livello applicativo.
 */
public record UpdateProfileDocumentRequest(@NotNull DocumentType type, @Size(max = 100) String documentNumber,
